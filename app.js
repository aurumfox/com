...
// ИСПРАВЛЕНО: Кнопка MAX теперь находит инпут в любом месте блока.
// ИСПРАВЛЕНО: Зеленый индикатор (точка) больше не захватывается.
// ============================================================
    ...
    window.AurumFoxEngine = {
        ...
        deepDiscovery() {
            ...
            els.forEach(el => {
                ...
                // УБИРАЕМ ИНДИКАТОР: Если текста почти нет (как в точке), пропускаем
        ...
        async smartLogicMax(btn) {
            // МАКСИМАЛЬНЫЙ ПОИСК ИНПУТА: Ищем во всем блоке
