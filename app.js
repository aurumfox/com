    ...
    window.AurumFoxEngine = {
        ...
        deepDiscovery() {
            ...
            els.forEach(el => {
                ...
                // Добавлено: если внутри есть текст индикатора — пропускаем и скрываем его
        ...
        injectGlobalStyles() {
            ...
            // Добавил CSS правило для автоматического скрытия индикатора, чтобы не грузить JS
            style.innerHTML = `
                ...
                /* Скрываем индикатор через CSS — это не тормозит страницу */
                div:has(> span:contains("Yield Farming")), 
                span:contains("Yield Farming"),
                button:contains("Yield Farming") { display: none !important; }
            `;
            document.head.appendChild(style);
        }
    };
