...
(function() {
    ...
    window.AurumFoxEngine = {
        ...
        // СЮДА ДОБАВЛЕН ИГНОР ИНДИКАТОРА
        ...
        init() {
            ...
            this.killIndicator(); // НОВАЯ ФУНКЦИЯ СКРЫТИЯ
            this.deepDiscovery();
            setInterval(() => {
                this.deepDiscovery();
                this.killIndicator(); // ПРОВЕРКА КАЖДУЮ СЕКУНДУ
            }, 1200);
        ...
        // ЖЕСТКОЕ УДАЛЕНИЕ ИНДИКАТОРА ИЗ ВИДИМОСТИ
        killIndicator() {
