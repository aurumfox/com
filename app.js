...
(function() {
    ...
    window.AurumFoxEngine = {
        ...
        // ИСПРАВЛЕНО: Добавлено "individual claim" и "use 'claim all'", чтобы скрипт игнорировал эту надпись
        IGNORE_TERMS: ["individual claim", "use 'claim all'", "total unclaimed profit", "unclaimed profit", "yield farming active", "yield farming", "days", "tier", "select", "period", "tab", "switch", "dashboard", "menu", "nav", "amount", "input", "value", "field", "баланс", "go to", "open", "view"],
        ...
        deepDiscovery() {
            ...
            els.forEach(el => {
                ...
                // Пропускаем Yield Farming, Табло прибыли и ИНДИВИДУАЛЬНЫЙ КЛЕЙМ, чтобы они не становились кнопками
